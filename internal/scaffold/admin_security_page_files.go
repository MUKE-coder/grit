...
// adminSecurityPageTSX is now a redirect to the Account screen.
//
// Everything this page showed lives on /system/account, under Security and
// Devices. It is kept rather than deleted because it was the address in the
// user menu for several versions, and somebody has it bookmarked.
