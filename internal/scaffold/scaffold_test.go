...
func TestWriteWebTanStackFiles(t *testing.T) {
	...
	files := []string{
		...
		filepath.Join(root, "apps", "web", "src", "routes", "_site", "index.tsx"),
		filepath.Join(root, "apps", "web", "src", "routes", "_site.tsx"),
		filepath.Join(root, "apps", "web", "src", "routes", "_site", "blog", "index.tsx"),
		filepath.Join(root, "apps", "web", "src", "routes", "_site", "blog", "$slug.tsx"),
...
func TestWriteAdminTanStackFiles(t *testing.T) {
	...
	files := []string{
		...
		filepath.Join(root, "apps", "admin", "src", "components", "layout", "admin-layout.tsx"),
		...
		filepath.Join(root, "apps", "admin", "src", "components", "chrome", "CollapsibleSidebar.tsx"),
