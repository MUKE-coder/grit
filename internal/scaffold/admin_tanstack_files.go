...
func adminTanStackFileMap(root string, opts Options) map[string]string {
	...
	files := map[string]string{
		...
		filepath.Join(adminRoot, "src", "pages", "magic-link.tsx"):               nextToTanStack(adminMagicLinkPage()),
		...
		filepath.Join(adminRoot, "src", "pages", "resources", "blogs.tsx"):       nextToTanStack(adminBlogsPage()),
		...
		filepath.Join(adminRoot, "src", "pages", "system", "audit.tsx"):          nextToTanStack(adminAuditPage()),
		filepath.Join(adminRoot, "src", "pages", "system", "api-keys.tsx"):       nextToTanStack(adminAPIKeysPage()),
		...
		filepath.Join(adminRoot, "src", "routes", "_auth", "magic-link.tsx"):                       adminTanStackPageRoute("/_auth/magic-link", "@/pages/magic-link"),
		...
		filepath.Join(adminRoot, "src", "routes", "_dashboard", "resources", "blogs", "$id.tsx"):   adminResourceDetailRouteTanStack("blogs", "blogs"),
		...
		filepath.Join(adminRoot, "src", "routes", "_dashboard", "system", "audit.tsx"):             adminTanStackPageRoute("/_dashboard/system/audit", "@/pages/system/audit"),
		filepath.Join(adminRoot, "src", "routes", "_dashboard", "system", "api-keys.tsx"):          adminTanStackPageRoute("/_dashboard/system/api-keys", "@/pages/system/api-keys"),
		...
		filepath.Join(adminRoot, "src", "hooks", "use-resource-url-state.ts"):         nextToTanStack(adminUseResourceURLState()),
		filepath.Join(adminRoot, "src", "hooks", "use-resource-selection.ts"):         nextToTanStack(adminUseResourceSelection()),
		filepath.Join(adminRoot, "src", "hooks", "use-resource-dialogs.ts"):           nextToTanStack(adminUseResourceDialogs()),
		...
		filepath.Join(adminRoot, "src", "resources", "blogs", "blogs.custom.tsx"): nextToTanStack(AdminResourceCustomStub("Blog", "Blog")),
...
`+tiptapDependencyLines("    ")+`    "axios": "^1.7.9",
    "clsx": "^2.1.1",
