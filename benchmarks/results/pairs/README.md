...
| pair | runs | notes |
|---|---|---|
| `bun/` | 24/24 | complete, on v3.134.0. The other five predate it and understate Grit |
...
the same run. Grit's single-row read measured 4,536 req/s in the Bun pair, 4,651
