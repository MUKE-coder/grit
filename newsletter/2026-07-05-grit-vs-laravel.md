...
> **Background:** a bold gradient from warm amber (#F59E0B) at the top-right into
> deep navy (#0B1120) at the lower-left, overlaid with a subtle evenly-spaced
> dot-grid pattern. **Headline:** the words **"Rails-style DX,\nGo performance"**
> in a heavy geometric sans-serif, pure white, inside a solid deep-navy highlight
> block anchored lower-left. **Right third:** a glossy 3D speedometer / gauge
> fused with a small stack of metallic layer chips, suggesting "familiar
> ergonomics + speed," soft amber rim light. **Top-left:** place the attached Grit
> logo mark with the wordmark "Grit Framework" beside it, small, high-contrast,
> Neon-style lockup. High contrast, generous whitespace, no people, no lens flare,
> no 3D text.
