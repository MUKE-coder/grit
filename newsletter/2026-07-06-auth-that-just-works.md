...
> **Background:** a bold gradient from emerald green (#10B981) into deep navy
> (#0B1120), overlaid with a subtle evenly-spaced dot-grid pattern. **Headline:**
> the words **"Auth that\njust works"** in a heavy geometric sans-serif, pure
> white, inside a solid deep-navy highlight block anchored lower-left. **Right
> third:** a glossy 3D padlock/shield fused with a small floating panel of auth
> chips labeled JWT, OAuth, 2FA, RBAC — a subtle green checkmark glow. **Top-left:**
> place the attached Grit logo mark with the wordmark "Grit Framework" beside it,
> small, high-contrast, Neon-style lockup. High contrast, generous whitespace, no
> people, no lens flare, no 3D text.
