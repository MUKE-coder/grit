...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: '↳ vs Node / Express', href: '/docs/benchmarks/express' },
      { title: '↳ vs Next.js', href: '/docs/benchmarks/nextjs' },
      { title: '↳ vs Bun', href: '/docs/benchmarks/bun' },
      { title: '↳ vs Django', href: '/docs/benchmarks/django' },
      { title: '↳ the Grit side', href: '/docs/benchmarks/grit' },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Docker address pools', href: '/docs/deployment/docker-networks' },
      ...
      { title: 'AWS EC2', href: '/docs/deployment/aws-ec2' },
      { title: 'AWS Lightsail', href: '/docs/deployment/aws-lightsail' },
    ],
  },
  {
