 ...
 * long way — Grit's single-row read measured 4,536 req/s in the Bun pair and
 * 8,509 in the Express pair, from an identical binary in the same sitting, as
 * write scenarios accumulated in Postgres.
