              ...
              <table className="w-full text-sm">
                ...
                <tbody className="divide-y divide-border/30">
                  {[
                    ...
                    ['grit generate seeder <Resource>', 'Generate a seeder for existing resources'],
                    ['grit generate sequence <Name>', 'Generate a sequential numbering helper'],
                    ...
                    ['grit package', 'Build a distributable desktop installer'],
                    ...
                    ['grit backup', 'Back up the entire database'],
