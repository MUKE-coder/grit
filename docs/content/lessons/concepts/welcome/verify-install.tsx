      ...
      <KnowledgeCheck
        ...
        choices={[
          ...
          },
          {
            ...
            feedback:
              "Wrong — the whole point of the version check is to skip the download when you're current. v3.26.2 added this short-circuit specifically to avoid wasted go install runs.",
          },
          {
...
✓ Already on the latest version (v3.26.2). Nothing to do.
\`\`\``}
            />
            <p>
