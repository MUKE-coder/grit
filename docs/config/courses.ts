      ...
      modules: [
        {
          ...
          lessons: [
            ...
            },
            {
              ...
              tagline: 'Read every one of the 8 generated files for Contact and connect them mentally.',
              minutes: 10,
              difficulty: 'medium',
              status: 'available',
            },
        ...
        },
        {
          ...
          lessons: [
            ...
            {
              slug: 'short-vs-long-form',
              title: 'Short form vs long form (inline --fields vs YAML --from)',
              tagline: 'When each shines, and exactly what the long form lets you express that the short form can\'t.',
              minutes: 8,
              difficulty: 'medium',
              status: 'available',
            },
        ...
        {
          title: 'Customising the generated UI',
          lessons: [
            {
              slug: 'customising-forms',
              title: 'Customising admin forms',
              tagline: 'The 17 field types, helper text, multi-step flows, when to drop out of the declarative form.',
              minutes: 12,
              difficulty: 'medium',
              status: 'available',
            },
