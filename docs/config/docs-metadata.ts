...
export const docsMetadata: Record<string, DocPage> = {
  ...
  '/docs/benchmarks': {
    title: 'Benchmarks: Grit vs Laravel, Django, Next.js, Express, Bun and Encore.ts',
    description:
  ...
  '/docs/frontend/ui-components': {
    title: 'UI Components',
    description:
      'Grit UI &ndash; 100 ready-made React components for marketing, SaaS, ecommerce, auth and layout. Install with grit ui add, or npx shadcn add in any React project.',
  },
